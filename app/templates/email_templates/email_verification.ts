export const emailVerificationTemplate = (logo, name, url, app_name ,year) => `
                          ...
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            <table class="ax-center" role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                    <img class="w-24" src="${logo}" style="height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; width: 96px; border-style: none; border-width: 0;" width="96">
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                              ...
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
                                    ...
                                    Terima kasih telah mendaftar di ${app_name}. Untuk menyelesaikan proses pendaftaran, kami memerlukan Anda untuk memverifikasi alamat email Anda. 
                                    Harap klik tautan di bawah ini untuk memverifikasi email Anda:
                                    </p>
                                    <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                      <tbody>
                                        <tr>
                                    ...
                                    <table class="btn btn-primary p-3 fw-700" role="presentation" border="0" align="center" cellpadding="0" cellspacing="0" style="border-radius: 6px; border-collapse: separate !important; font-weight: 700 !important;">
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; border-radius: 6px; font-weight: 700 !important; margin: 0;" align="center" bgcolor="#0d6efd">
                                            <a href="${url}" style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: 700 !important; white-space: nowrap; background-color: #0d6efd; padding: 12px; border: 1px solid #0d6efd;">Verfikasi Email</a>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    <p style="color: #718096;">
                                        <i>
                                        Jika Anda tidak mendaftar di ${app_name}, harap abaikan email ini.
                                        </i>
                                    </p>
                                  </td>
                                </tr>
